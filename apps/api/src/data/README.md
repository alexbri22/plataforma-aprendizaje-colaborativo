...
(sección 11 del general). Solo la capa de servicios de cada módulo puede
importar de aquí; ningún módulo accede a los datos de otro directamente
(regla de frontera, sección 3.4 del general).
